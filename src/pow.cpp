...
bool CheckProofOfWork(uint256 hash, unsigned int nBits, const Consensus::Params& params, bool fGenerate)
{
    bool fNegative;
    bool fOverflow;
    ...
    if (UintToArith256(hash) > bnTarget)
        return fGenerate ? false : error("CheckProofOfWork(): hash doesn't match nBits");
